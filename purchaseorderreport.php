...
// Ensure database connection is available from db_connection.php
if (!$conn) {
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                <li><a href="quotationlist.php">Quotation List</a></li> <!-- Fixed typo: quotationList.php to quotationlist.php -->
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                <li><a href="purchaseorderreport.php" class="active">Purchase order report</a></li>
            ...
            <div class="content">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        $conditions = ["pur.purchaseStatus = 1"];
                        $params = [];
                        $types = "";

                        if (!empty($_GET['from_date'])) {
                            $fromDate = date('Y-m-d', strtotime($_GET['from_date']));
                            $conditions[] = "pur.purchaseDate >= ?";
                            $params[] = $fromDate;
                            $types .= "s";
                        }
                        ...
                        $query = "
                            SELECT
                                ...
                                p.quantity AS 'Instock QTY'
                            FROM
                                purchase_details pd
                            JOIN 
                                products p ON pd.productId = p.productId
                            JOIN 
                                purchases pur ON pd.purchaseNumber = pur.purchaseNumber
                            WHERE $whereClause
                            GROUP BY 
                                p.productId, p.productName, p.quantity
                            ORDER BY 
