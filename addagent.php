        ...
        echo "<script>
            document.addEventListener('DOMContentLoaded', function () {
                Swal.fire({
                    ...
                    window.location.href = 'addagent.php';
               });
            });
        </script>";
    } else {
...
<head>
    ...
    <title>Sonak Inventory | Add Agent</title>
...
<body>
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="page-header">
                    ...
                    <div class="page-btn">
                        <a href="agentlist.php" class="btn btn-added"><img src="assets/img/icons/card-list.svg" alt="img">&nbsp;Agents List</a>
                    </div>
    ...
    <script>
        ...
        function validateInput(input) {
            ...
            if (name === 'agent_phone' && !/^0[0-9]{9}$/.test(value)) {
