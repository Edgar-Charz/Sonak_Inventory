...
if (isset($_POST['updateProductBTN'])) {
    ...
    $current_data_query = "SELECT productName, productCategoryId, productType, productUnitId, productQuantity, productQuantityAlert, productBuyingPrice, productSellingPrice, productNotes, productTax 
                                FROM 
                                    products 
                                WHERE 
                                    productId = ?";
    ...
    if (
        ...
        if ($name_result->num_rows > 0) {
            ...
            $update_product_query = "UPDATE 
                                        products 
                                        SET 
                                          productName = ?, productCategoryId = ?, productType = ?, productUnitId = ?, productQuantity = ?, productQuantityAlert = ?, productBuyingPrice = ?, productSellingPrice = ?, productNotes = ?, productTax = ?, updated_at=? 
                                        WHERE 
                                            productId=?";
